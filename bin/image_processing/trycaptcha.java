...
public class trycaptha {
	...
	public static void prework() throws IOException
	{
		...
		for(forr = 0; forr < 62; ++forr)
		{
			...
			File file;
			if(ch >= 'a')
				file = new File(System.getProperty("user.dir") + "/src/" + ch + "1.png");  
			else
				file = new File(System.getProperty("user.dir") + "/src/" + ch + ".png");  
	...
	public static void main(String[] args) throws IOException {
		...
		File file = new File(System.getProperty("user.dir") + "/src/captcha/" + "captcha" + ".jpg");
		BufferedImage image = ImageIO.read(file);
		binaryImage(image);
		file = new File(System.getProperty("user.dir") + "/src/captcha/" + "captcha" + ".png");
...
//		System.out.printf("%d %d %d %d\n", po[0], po[1], po[2], po[3]);
		System.out.printf("%c%c%c%c\n", ys[an[0]], ys[an[1]], ys[an[2]], ys[an[3]]);
	}
